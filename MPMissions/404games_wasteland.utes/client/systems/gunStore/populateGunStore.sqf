...
switch(_switch) do 
{
    case 0: // Weapons button pressed.
    {
        ...
        // Populate the gun shop weapon list
            ...
            _gunlistIndex = _gunlist lbAdd format["%1",_name];
    ...
    case 1: // Weapons - Pistols button pressed.
    {
        ...
        // Populate the gun shop weapon list
        {
        	if (_x select 0 == 1) then {_weapon = configFile >> "cfgWeapons" >> (_x select 1);_name = getText(_weapon >> "displayName");
                _gunlistIndex = _gunlist lbAdd format["%1",_name];
            };
        } forEach weaponsArray;
    };
    ...
    case 2: // Weapons - Rifles button pressed.
    {
        ...
        // Populate the gun shop weapon list
        {
        	if (_x select 0 == 2) then {_weapon = configFile >> "cfgWeapons" >> (_x select 1);_name = getText(_weapon >> "displayName");
                _gunlistIndex = _gunlist lbAdd format["%1",_name];
            };
        } forEach weaponsArray;
    };
    ...
    case 3: // Weapons - Snipers button pressed.
    {
        ...
        // Populate the gun shop weapon list
        {
        	if (_x select 0 == 3) then {_weapon = configFile >> "cfgWeapons" >> (_x select 1);_name = getText(_weapon >> "displayName");
                _gunlistIndex = _gunlist lbAdd format["%1",_name];
            };
        } forEach weaponsArray;
    };
    ...
    case 4: // Weapons - Machineguns button pressed.
    {
        ...
        // Populate the gun shop weapon list
        {
        	if (_x select 0 == 4) then {_weapon = configFile >> "cfgWeapons" >> (_x select 1);_name = getText(_weapon >> "displayName");
                _gunlistIndex = _gunlist lbAdd format["%1",_name];
            };
        } forEach weaponsArray;
    };
    ...
    case 5: // Weapons - RPGs button pressed.
    {
        ...
        // Populate the gun shop weapon list
        {
        	if (_x select 0 == 5) then {_weapon = configFile >> "cfgWeapons" >> (_x select 1);_name = getText(_weapon >> "displayName");
                _gunlistIndex = _gunlist lbAdd format["%1",_name];
            };
        } forEach weaponsArray;
    };
