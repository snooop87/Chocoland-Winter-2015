...
player addEventHandler ["Respawn", {[this]execVM"client\clientEvents\onRespawnAnimal.sqf"}];
player addEventHandler ["Killed", {[this] execVM "server\functions\bomb_midair.sqf";}];
