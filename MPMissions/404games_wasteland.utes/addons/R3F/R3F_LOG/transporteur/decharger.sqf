...
else
{
	...
	if !(isNull _objet_a_decharger) then
	{
		...
		{
			[_objet_a_decharger] execVM "addons\R3F\R3F_LOG\objet_deplacable\deplacer.sqf";
		}
		else
		{
			...
			chocoland globalChat STR_R3F_LOG_action_decharger_en_cours;
			...
			chocoland globalChat STR_R3F_LOG_action_decharger_fait;
		};
	}
	else
	{
		chocoland globalChat STR_R3F_LOG_action_decharger_deja_fait;
	};
