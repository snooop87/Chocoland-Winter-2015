...
Flare7 = "SmokeShellblack" createVehicle position vehicle player;Flare7 attachTo [vehicle player,[-3,0,0]];
Flare8 = "SmokeShellblue" createVehicle position vehicle player;Flare8 attachTo [vehicle player,[-4,0,0]];
