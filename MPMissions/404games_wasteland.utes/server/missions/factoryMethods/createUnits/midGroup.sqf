...
_leader addMagazine "PG7VR";
_leader addMagazine "PG7VR";
_leader addWeapon "RPG7V";
_leader setskill ["general", 1];
_leader setskill ["spotTime", 2];
_leader setskill ["aimingShake", 0.5];
_leader setskill ["aimingSpeed", 0.5];
_leader setskill ["aimingAccuracy",0.3];
